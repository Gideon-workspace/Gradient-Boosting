...
- Employs Gradient Boosting for high accuracy and robust performance.
- Provides insights that can help identify students who may need additional support.
...
- **Objective:** Classify students into different types based on performance and engagement.
- **Evaluation Metrics:** Accuracy, Confusion Matrix, and F1-score.

## How to Use
1. Clone the repository:
   ```bash
   git clone https://github.com/your-username/student-classification.git
